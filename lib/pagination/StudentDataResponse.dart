...
StudentDataResponse welcomeFromJson(String str) => StudentDataResponse.fromJson(json.decode(str));

String welcomeToJson(StudentDataResponse data) => json.encode(data.toJson());
...
class StudentDataResponse {
  ...
  factory StudentDataResponse.fromJson(Map<String, dynamic> json) => StudentDataResponse(
